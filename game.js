...
const battle = async () => {
    ...
    while (p1.fuel > 0 && o1.fuel > 0) {
        ...
        if (actions.opt === "Attack") {
            ...
            if (num === 0) {
                console.log(chalk.red.bold("Your attack missed!"));
                p1.fuelDecrease();
            }
            else if (num === 1) {
                o1.fuelDecrease();
                ...
                p1.fuelIncrease();
                console.log(chalk.green.bold("You landed a solid hit!"));
            }
        }
...
if (opponent.select === "Skeleton") {
    ...
    console.log(chalk.bold.green("You are facing a Zombie! Can you survive this undead threat?"));
    battle();
}
